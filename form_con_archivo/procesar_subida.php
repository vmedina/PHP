...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES['archivo']) && $_FILES['archivo']['error'] == 0) {
        ...
        if (!file_exists($carpetaDestino)) {
            ...
            *
            *true: Es el tercer argumento, un valor booleano que indica si se deben crear los directorios padre que no existan. Si se establece en true, se crean todos los directorios necesarios de manera recursiva. Si se establece en false, solo se crea el directorio especificado y se genera un error si alguno de los directorios padre no existe.
             * 
             */
        }
