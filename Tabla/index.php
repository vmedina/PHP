...
foreach ($equipos as $equipo) {
    ...
    foreach ($equipo as $key => $value) {
        ...
        elseif($key == 'puntos')
        {
            ...
            if ($currentKeyIndex !== false && ($currentKeyIndex + 3) < count($equipo)) {
                $partidosGanados = $equipo[$keys[$currentKeyIndex + 1]];                
                $partidosEmpatados = $equipo[$keys[$currentKeyIndex + 3]];
